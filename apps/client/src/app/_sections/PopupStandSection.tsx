...
export function PopupStandSection() {
  const t = useTranslations("popupStand");
      ...
      <div className="grid lg:grid-cols-2 items-stretch">
        ...
        <div className="flex flex-col justify-center px-8 sm:px-12 lg:pr-[max(3rem,calc((100vw-72rem)/2+3rem))] lg:pl-16 py-16 lg:py-28 order-last lg:order-last">
          ...
          <motion.div ref={ref}
            ...
            className="mb-16"
          >
            <p className="text-muted-foreground text-xs font-semibold uppercase tracking-[0.2em] mb-5">{t("label")}</p>
          ...
          <div
            ...
            >
              ...
              <div className="absolute bottom-6 left-0 right-0 flex justify-center gap-3">
                {SLIDES.map((_, i) => (
                  <button key={i} onClick={() => goTo(i, i > active ? 1 : -1)} aria-label={t("slideLabel", { n: i + 1 })}
